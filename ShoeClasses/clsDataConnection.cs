...
public class clsDataConnection
{
    ...
    {
        connectionString = "Server=tcp:rssp.database.windows.net,1433;Initial Catalog=OnlineShoeShop;Persist Security Info=False;User ID=rssponlineshoeshop;Password= Porkchop7;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
    }
